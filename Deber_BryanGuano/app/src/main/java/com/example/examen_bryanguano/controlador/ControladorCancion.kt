...
//            put("idAlbum", idAlbum)
//        }
//        db.insert("Cancion", null, valores)
//        db.close()
//    }
//
//    fun listarCancionesPorAlbum(idAlbum: Int): List<Cancion> {
...
//            "SELECT * FROM Cancion WHERE idAlbum  = ?", // Actualizado
//            arrayOf(idAlbum .toString())
//        )
//        val canciones = mutableListOf<Cancion>()
//        while (cursor.moveToNext()) {
//            val idCancion = cursor.getInt(cursor.getColumnIndexOrThrow("idCancion"))
...
//            canciones.add(Cancion(idCancion, titulo, artista, genero, duracion))
//        }
//        cursor.close()
//        db.close()
//        return canciones
...
//            put("duracion", cancion.duracion)
//        }
//        val rows = db.update("Cancion", values, "idCancion = ?", arrayOf(cancion.idCancion.toString()))
//        db.close()
//        return rows > 0
//    }
//
//    fun eliminarCancion(idCancion: Int): Boolean {
//        val db = dbHelper.writableDatabase
//        val rows = db.delete("Cancion", "idCancion = ?", arrayOf(idCancion.toString()))
//        db.close()
//        return rows > 0
//    }
//
//    fun depurarCanciones() {
//        val db = dbHelper.readableDatabase
//        val cursor = db.rawQuery("SELECT * FROM Cancion", null)
//        while (cursor.moveToNext()) {
//            val idCancion = cursor.getInt(cursor.getColumnIndexOrThrow("idCancion"))
//            val titulo = cursor.getString(cursor.getColumnIndexOrThrow("titulo"))
//            val artista = cursor.getString(cursor.getColumnIndexOrThrow("artista"))
//            val genero = cursor.getString(cursor.getColumnIndexOrThrow("genero"))
//            val duracion = cursor.getDouble(cursor.getColumnIndexOrThrow("duracion"))
//            println("Cancion: $idCancion, Título: $titulo, Artista: $artista, Genero: $genero, Duración: $duracion")
//        }
//        cursor.close()
//        db.close()
//    }
